...
const SkillsPage = () => (
  ...
  <Layout>
    ...
    <Section name = "Skills">
        ...
        <div className="skill-category mt-4  mb-3">Web</div>
        <ul className="list-inline list-icons">
          <li className="list-inline-item skill skill-level-expert">
        ...
        <div className="skill-category mt-4 mb-3" >Technologies</div>
        <ul className="list-inline list-icons">
          <li className="list-inline-item skill skill-level-high">
        ...
        <div className="skill-category mt-4 mb-3">Development Environment</div>
        <ul className="list-inline list-icons">
          <li className="list-inline-item skill skill-level-expert">
        ...
        <div className="skill-category mt-4 mb-3">Software</div>
        <ul className="list-inline list-icons">
          <li className="list-inline-item skill skill-level-high">
        ...
        <div className="skill-category mt-4 mb-3">Other</div>
        <ul className="list-inline list-icons">
          <li className="list-inline-item skill skill-level-expert">
      ...
      <h2 className="mb-5">Formal Training</h2>
      <div className="skill-category mt-4 mb-3">Undergraduate Courses</div>
      <ul className="list-inline list-icons">
      ...
      <div className="skill-category mt-4 mb-3">Graduate</div>
      <ul className="list-inline list-icons">
        <li className="list-inline-item skill skill-className">
          <div className="skill-icon skill-icon-className"/>
